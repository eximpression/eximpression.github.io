 ...
 */
define('base:thirdParty/san/san.js', function (require, exports, module) {
...
(function (root) {
        ...
        function (method) {
            ForItemData.prototype[method] = function (expr) {
                ...
                this.parent[method].apply(
                    this.parent, [expr].concat(Array.prototype.slice.call(arguments, 1))
                );
            };
        }
    );
    ...
    function forOwnUpdate(changes) {
                    ...
                    switch (change.type) {
                        ...
                        case DataChangeType.SPLICE:
                            Data.prototype.splice.call(
                                this.children[changeIndex].scope,
                                change.expr, [].concat(change.index, change.deleteCount, change.insertions), {
                                    silent: 1
                                }
                            );
                            break;
        ...
        each(disposeChildren, function (child) {
            ...
            child.dispose({
                dontDetach: violentClear,
                noTransition: violentClear
            });
        });
    ...
    function elementDispose(element, options) {
        elementDisposeChildren(element, {
            dontDetach: true,
            noTransition: true
        });
    ...
    var componentPropExtra = [{
            name: 'class',
            expr: parseText("{{class | _class | _sep(' ')}}")
        },
        {
            name: 'style',
            expr: parseText("{{style | _style | _sep(';')}}")
        }
    ];
    /* eslint-enable quotes */
